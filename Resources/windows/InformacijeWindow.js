  ...
  feri.ui.createInformacijeWindow = function() {
    ...
    webview.addEventListener('load', function() {
      ...
      if (!feri.isAndroid()) {
        ...
        webview.evalJS('javascript:(function evilGenius(){' + 'var s=document.createElement("style");' + 's.setAttribute("type","text/css");' + 's.innerHTML="' + contents + '";' + 'document.getElementsByTagName("head")[0].appendChild(s);' + '})();');
